        ...
        const template_path = try std.fs.path.join(arena.allocator(), &.{ cwd_path, temp_dir_name, "template" });
        {
            ...
            const issue_data = [_]struct {
                ...
                .{
                    ...
                    .tags = "bug\x00priority-high\x00crash",
                },
                .{
                    ...
                    .tags = "enhancement\x00ui\x00theme",
                },
                .{
                    ...
                    .tags = "bug\x00memory\x00networking",
                },
                .{
                ...
                .{
                    ...
                    .tags = "enhancement\x00ux\x00keyboard",
                },
                .{
                ...
                .{
                    ...
                    .tags = "dependencies\x00maintenance",
                },
                .{
                ...
                .{
                    ...
                    .tags = "bug\x00priority-high\x00data-loss",
                },
                .{
                ...
                .{
                    ...
                    .tags = "performance\x00priority-high",
                },
                .{
                    ...
                    .tags = "bug\x00editor\x00clipboard",
                },
                .{
                    ...
                    .tags = "enhancement\x00ux\x00auth",
                },
                .{
            ...
            try evt.commitAndConsume(.{}, io, allocator, &template_repo, evt.events_ref, &issue_events);
        }
