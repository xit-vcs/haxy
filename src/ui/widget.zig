...
pub const Widget = union(enum) {
    ...
    repo_issue_detail: ui.Repo.Issues.Detail,
    repo_patch_detail: ui.Repo.Patches.Detail,
    ...
    pub fn atTop(self: *Widget, root_focus: *Focus) bool {
        return switch (self.*) {
            inline .home_about, .home_users, .home_repos, .flow_box_scroll, .home_settings, .auth_login, .auth_logout, .quit, .repo_files, .repo_commits, .diff_view, .repo_refs, .repo_issues, .repo_patches, .repo_discussions, .repo_events, .repo_undo => |*view| view.atTop(),
...
pub const SearchHeader = struct {
    ...
    pub fn deinit(self: *SearchHeader, allocator: std.mem.Allocator) void {
    ...
    pub fn clearGrid(self: *SearchHeader) void {
        self.box.clearGrid();
    }

    pub fn getGrid(self: SearchHeader) ?Grid {
        return self.box.getGrid();
    }

    pub fn getFocus(self: *SearchHeader) *Focus {
